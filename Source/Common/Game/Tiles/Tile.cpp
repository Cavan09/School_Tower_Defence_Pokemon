...
{
    //if the pickup already points to a pickupobject, we need to delete it
    if(m_Pickup != NULL)
    {
        delete m_Pickup;
        m_Pickup = NULL;
    ...
    //Set the new pickup object tot he m_Pickup pointer
    m_Pickup = pickup;
}
