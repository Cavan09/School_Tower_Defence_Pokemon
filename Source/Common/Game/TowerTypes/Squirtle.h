...
#ifndef __GAM_1514_OSX_Game__Squirtle__
#define __GAM_1514_OSX_Game__Squirtle__
...
{
public:
    Squirtle(Level* level,Tile* tile, float speed,int heath,const char* textureFile);
    ~Squirtle();
...
#endif /* defined(__GAM_1514_OSX_Game__Squirtle__) */
