...
const char* RES_TILE_TREE = "TreeTile";
const char* RES_TILE_ROCK = "RockTile";
const char* RES_TILE_WATER = "WaterTile";
const char* RES_TILE_GRASS = "GrassTile";
const char* RES_TILE_PAVED = "PavedTile";
